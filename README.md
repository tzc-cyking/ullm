...
Authors: Chenyu Jin, Chenglong Wang, Jun Wang, Honghui Xu*, Shiqing Zhang*,~\IEEEmembership{Senior Member,~IEEE}, Jun Yu, and  Qi Tian, ~\IEEEmembership{Fellow,~IEEE}
...
- (AUG 25, 2026) The final model weights are shared on Google Drive!
